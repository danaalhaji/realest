		...
		<div class="container">
			...
			<div class="navbar-collapse collapse d-flex flex-row-reverse"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link active" href="#">Property</a>
					</li>
							...
							<div class="card-overlay-a-content">
								<div class="card-header-a">
									<h2 class="card-title-a">
										<a href="/properey/${property.id}">${property.proName} <br/></a>
									</h2>
								</div>
								<div class="card-body-a">
									<div class="price-box d-flex">
										<span class="price-a">price | $ ${property.satrtingPrice}</span>
									</div>
									<a href="/properey/${property.id}" class="link-a">Click
										here to view <span class="ion-ios-arrow-forward"></span>
									</a>
								</div>
								<div class="card-footer-a">
									<ul class="card-info d-flex justify-content-around">
										<li>
											<h4 class="card-info-title">Areas</h4> <span>${property.satrtingArea} - ${property.endingArea}
												<sup>2</sup>
										</span>
										</li>
										<li>
					...
					<nav class="pagination-a">
						<ul class="pagination justify-content-end">
							<li class="page-item disabled"><a class="page-link" href="#"
								tabindex="-1"> <span class="ion-ios-arrow-back"></span>
							</a></li>
