		...
		<div class="container">
			...
			<div class="navbar-collapse collapse d-flex flex-row-reverse"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><c:if test="${customer_id  == null}">
							<div class="btn-group">
								<button type="button"
								...
								<div class="dropdown-menu signin-popup-form-container pt-4">
									<div id="login-form" class="login-form px-3">
										<form:form action="/login/customer" method="post"
											modelAttribute="newLoginCustomer">
						...
						<div class="card-overlay">
							<div class="card-overlay-a-content">
								...
								<div class="card-body-a">
									...
									<a href="/detail" class="link-a">Click here to view <span
										class="ion-ios-arrow-forward"></span>
									</a>
								</div>
